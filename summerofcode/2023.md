...
- [Ideas](#ideas)
  ...
  * [Kubearmor](#kubearmor)
    + [GitHub Action for Kubearmor](#github-action-for-kubearmor)
...
#### GitHub Action for KubeArmor
- Description: Build a GitHub action to allow the usage of kubearmor in the CI
- Expected outcome: Find security gaps and recommend policies leveraging GitHub action. The action should be able to  generate a summary using baseline benchmark and then show the application based changes in the graphical mode.
- Mentor(s): Ankur Kothiwal(Ankurk99), Anurag Kumar(kranurag7), Barun Acharya(daemon1024)
- Expected project size: 175 Hours
...
- Description: Store kubearmor policies & host policies in OCI registry.
- Expected outcome: Add subcommands for karmor to be able to interact with OCI registeries for pushing, pulling and verifying policies. List the policies on artifact hub.
- Mentor(s): Ankur Kothiwal(Ankurk99), Anurag Kumar(kranurag7), Barun Acharya(daemon1024)
- Expected project size: 175 Hours
